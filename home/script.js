const translations = {
  en: {
    pageTitle: "LinuxToys: Developer Portal",
    ...
    easyText: "The simplest LinuxToys integration needs little more than a GitHub repository and a released AppImage. There is no packaging maze to solve before you can reach your users, so you can focus on developing your app to its best.",
    ...
    step1Title: "Publish",
    step1Text: "Release your application through the channel that already fits your project, such as GitHub or Codeberg releases.",
    step2Title: "Declare",
    step2Text: "Describe the package or procedure LinuxToys should use, with optional soft dependencies, compatibility rules and various hooks.",
    step3Title: "Reach users",
  ...
  "pt-BR": {
    pageTitle: "LinuxToys: Portal do Desenvolvedor",
    ...
    easyText: "A integração mais simples com o LinuxToys precisa de pouco mais do que um repositório no GitHub e um AppImage publicado. Você não precisa enfrentar um labirinto de empacotamento antes de chegar aos seus usuários, então pode se concentrar em desenvolver seu aplicativo ao seu máximo.",
    ...
    step1Title: "Publique",
    step1Text: "Lance seu aplicativo pelo canal que já faz sentido para o projeto, como releases do GitHub ou Codeberg.",
    step2Title: "Declare",
    step2Text: "Descreva o pacote ou procedimento que o LinuxToys deve usar, com regras de compatibilidade, dependências leves e hooks variados opcionais.",
    step3Title: "Alcance usuários",
...
function getInitialLanguage() {
  ...
  return prefersPortuguese ? "pt-BR" : "en";
}
